                    ...
                    <div class="container-fluid">
                        <form action="./login.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control rounded-0" value="<?= isset($_POST['password']) ? $_POST['password'] : '' ?>" minlength="10" maxlength="15" required>
                            </div>

                            <div class="clear-fix mb-4"></div>
                            <div class="form-group text-end">
                                <a class="btn btn-success" href="registration.php">Create New Account</a>
                                <button class="btn btn-primary bg-gradient rounded-0" id="log-in">LOGIN</button>
